 ...
 *------------------------------------------------------------------------------ */
/* ./iirGen.pl -A 256 0 378 0 179 0 32 0 2 0 0 0 -B 0 4 22 68 136 191 191 136 68 22 4 0 -moduleName acm_filter -fractionalBits 8 -bitWidth 32 -inData inData -inReg -outReg -outData outData -clk clk -reset reset -reset_edge negedge -filterForm 1 -outFile ../outputs/filter_1527972961.v */
...
module acm_filter_firBlock_left_MultiplyBlock (
  ...
  assign Y[0]  =  coef[7:0]*X; //w4[39:8];
  assign Y[1]  =  coef[15:8]*X; //w22[39:8];
  assign Y[2]  =  coef[23:16]*X; //w68[39:8];
  assign Y[3]  =  coef[31:24]*X; //w136[39:8];
  assign Y[4]  =  coef[39:32]*X; //w191[39:8];
  assign Y[5]  =  coef[47:40]*X; //w191[39:8];
  assign Y[6]  =  coef[55:48]*X; //w136[39:8];
  assign Y[7]  =  coef[63:56]*X; //w68[39:8];
  assign Y[8]  =  coef[71:64]*X; //w22[39:8];
  assign Y[9]  =  coef[79:72]*X; //w4[39:8];
  assign Y[10] =  w0[39:8];
...
module acm_filter_firBlock_right_MultiplyBlock (
  ...
  //acm_filter_firBlock_right_MultiplyBlock area estimate = 16402.4783787809;
...
module acm_filter_firBlock_right (
  ...
  //acm_filter_firBlock_right area estimate = 42574.5943051662;
