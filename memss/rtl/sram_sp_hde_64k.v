...
//      Test Muxes                  Off
//
//      Creation Date:  Tue Aug  2 11:52:04 2016
//      Version: 	r2p0-01rel0
//
...
`celldefine
`ifdef POWER_PINS
module sram_sp_hde_64k (Q, CLK, CEN, WEN, A, D, EMA, RETN, VSSE, VDDPE, VDDCE);
`else
module sram_sp_hde_64k (Q, CLK, CEN, WEN, A, D, EMA, RETN);
`endif
...
`endif
  ...
  begin
    if (RETN_int === 1'bx) begin
      ...
      Q_int = {data_out[992], data_out[960], data_out[928], data_out[896], data_out[864],
        data_out[832], data_out[800], data_out[768], data_out[736], data_out[704],
        data_out[672], data_out[640], data_out[608], data_out[576], data_out[544],
        data_out[512], data_out[480], data_out[448], data_out[416], data_out[384],
        data_out[352], data_out[320], data_out[288], data_out[256], data_out[224],
        data_out[192], data_out[160], data_out[128], data_out[96], data_out[64], data_out[32],
        data_out[0]};
    end
  end
  endtask
...
`endif
  ...
  reg NOT_A0, NOT_A1, NOT_A10, NOT_A11, NOT_A12, NOT_A13, NOT_A2, NOT_A3, NOT_A4, NOT_A5;
  reg NOT_A6, NOT_A7, NOT_A8, NOT_A9, NOT_CEN, NOT_CLK_MINH, NOT_CLK_MINL, NOT_CLK_PER;
  reg NOT_D0, NOT_D1, NOT_D10, NOT_D11, NOT_D12, NOT_D13, NOT_D14, NOT_D15, NOT_D16;
  reg NOT_D17, NOT_D18, NOT_D19, NOT_D2, NOT_D20, NOT_D21, NOT_D22, NOT_D23, NOT_D24;
  reg NOT_D25, NOT_D26, NOT_D27, NOT_D28, NOT_D29, NOT_D3, NOT_D30, NOT_D31, NOT_D4;
