...
set target_library { /home/projects/vlsi/libraries/65lpe/ref_lib/arm/std_cells/hvt/timing_lib/nldm/db/sc9_cmos10lpe_base_hvt_ss_nominal_max_1p08v_125c.db}
  ...
  analyze -library WORK -format sverilog " \
    ...
    $PROJECT_MODULES/rsa/rtl/modexp.v \
    $PROJECT_MODULES/rsa/rtl/adder.v \
    $PROJECT_MODULES/rsa/rtl/blockmem1r1w.v \
    $PROJECT_MODULES/rsa/rtl/blockmem2r1w.v \
    $PROJECT_MODULES/rsa/rtl/blockmem2r1wptr.v \
    $PROJECT_MODULES/rsa/rtl/blockmem2rptr1w.v \
    $PROJECT_MODULES/rsa/rtl/modexp_core.v \
    $PROJECT_MODULES/rsa/rtl/montprod.v \
    $PROJECT_MODULES/rsa/rtl/residue.v \
    $PROJECT_MODULES/rsa/rtl/shl.v \
    $PROJECT_MODULES/rsa/rtl/shr.v \
    $PROJECT_MODULES/rsa/rtl/modexp_top.v "
